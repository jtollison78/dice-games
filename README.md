...
Here are the correct rerolls for every combination of Victory Point dice rolled. Non-VP dice were simply set to 6s, which represent any combinations of 4s, 5s, and 6s. Many of the results here are obvious, but some aren't obvious and may be downright non-intuitive. For instance, if you roll 2 1s and no other victory dice, and you have 2 rolls left, don't keep the 1s.
